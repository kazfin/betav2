...
function randomCommunityGetter() { //a LOT simpler than randomFamilyGetter (insert PTSD flashbacks)//
	for (let i = getRandomIntInclusive(15, 35); i > 0; i--) {
		//sexer//
		if (getRandomIntInclusive(1,2) === 1) {
		...
		//namer//
		if (getRandomIntInclusive(1, 500) === 1) {
			CommunityNames.push(RareNames[getRandomIntInclusive(0, 5)]);
		} else {
			CommunityNames.push(FirstNames[getRandomIntInclusive(0, 69)] + " " + LastNames[getRandomIntInclusive(0, 56)]);
		}
		//ager//
